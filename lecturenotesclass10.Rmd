...
- **How many patients were enrolled in the clinical trial?** There were 84 
patients in this trial.

- **What is the probability a randomly selected patient received the placebo?** 
The probability is 43 out of 84, or 51.2%.

- **What is the probability a randomly selected patient received the placebo 
and had a marked improvement?** The probability is 7 out of 84, or 8.3%.
  
- **What is the probability a randomly selected patient received the placebo
  and the treatment?** These two things are not possible at the same time, so 
  the probability is 0.
  
- **What is the probability a randomly selected patient had some improvement or
  was on the treatment?** The probability is 48 out of 84, or 57.1%.
...
How about white?** The probability the marble is blue is 3/8, or 37.5%. The
probability of it being white is 1/8 or 12.5%.
...
**How close is this value to the "true" probability?** It is pretty close, as 
there are a lot of draws. As the size of samples increase, the probability will
get closer and closer to "true" probability because of the law of large numbers.
...
It is unlikely of getting the same color twice in a row. 
...
**Write down your guess to the answer before you calculate it.** I think that 
event 2 is more likely.
...
```{r summarize_rolls}
roll_results %>%
  summarise(event_prob_1 = mean(event_1),
            event_prob_2 = mean(event_2))
```
